...
export default function VisionMission() {
  return (
    <section className="relative bg-black text-white h-[500px] md:h-[600px] lg:h-[700px]">
      ...
      <div className="absolute inset-0 bg-black opacity-10 z-10 w-full"></div>

      {/* Content */}
      <div className="relative max-w-7xl mx-auto px-6 sm:px-8 py-24 z-20">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-14">
          {/* Vision Box */}
          <div className="bg-gray-900 rounded-lg p-8 sm:p-12 text-center shadow-lg transform md:mt-[-14rem]">
            <h3
              className="font-bold mb-4 sm:mb-6"
              style={{ fontSize: "55.5px" }} 
            >
              Our Vision
            </h3>
            <p
